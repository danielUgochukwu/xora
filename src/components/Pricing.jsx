    ...
    <section>
      <Element name={`pricing`}>
        <div className={`container`}>
          <div
            className={`max-w-900 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg-border-none max-md:pb-32 max-md:pt-16`}
          >
            <h3
              id="pricing-title"
              className={`h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm translate-y-20 opacity-0`}
            >
          ...
          >
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div
                  className={clsx(
                    "absolute left-0 right-0 z-2 flex-center",
